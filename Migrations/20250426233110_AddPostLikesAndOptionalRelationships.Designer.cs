...
namespace VoiceInfo.Migrations
{
    ...
    [Migration("20250426233110_AddPostLikesAndOptionalRelationships")]
    partial class AddPostLikesAndOptionalRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoiceInfo.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VoiceInfo.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PostTag", b =>
                {
                    b.HasOne("VoiceInfo.Models.Post", null)
                        .WithMany()
                        .HasForeignKey("PostsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VoiceInfo.Models.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VoiceInfo.Models.Comment", b =>
                {
                    ...
                    b.HasOne("VoiceInfo.Models.User", "Commenter")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("VoiceInfo.Models.Post", b =>
                {
                    b.HasOne("VoiceInfo.Models.Category", "Category")
                        .WithMany("Posts")
                        .HasForeignKey("CategoryId");

                    b.HasOne("VoiceInfo.Models.User", "Author")
                        .WithMany("Posts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
